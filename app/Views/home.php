...
//for filter
	$(document).ready(function() { $('#categorySelect').change(function() { var selectedOption = $(this).val(); $.ajax({ url: '<?= site_url('library/fetch-books') ?>', 
		type: 'POST',
		data: {option: selectedOption}, 
		dataType: 'json', success: function(response) { $('#booksList').empty(); // Clear the previous data 
		 // Append new data 
...
<div class="container-xl">
	<div class="table-responsive d-flex flex-column">
		...
		<div class="table-wrapper">
			...
			<!-- Pagination Links -->  <div>  <?= $pager ?> </div> 
